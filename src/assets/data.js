...
export const navigation = (role) => [
  ...
  },
  {
    ...
    href: "/app/create-request",
    role: [2, 4].includes(role),
    dropdown: [
      {
        label: "Business Name",
        href: "/app/create-request/new-request?q=business_name",
      },
      {
        label: "Limited Liability Company",
        href: "/app/create-request/new-request?q=limited_liability_company",
      },
      {
        label: "Incorporated Trustees",
        href: "/app/create-request/new-request?q=incorporated_trustees",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    icon: <PendingRequestuests />,
    href: "/app/pending-request",
    role: [3, 4, 5].includes(role),
  },
  {
    name: "Pending Request",
    icon: <PendingRequestuests />,
    href: "/app/pending-requestss",
    role: [1, 4].includes(role),
  },
  {
    name: "Completed Request",
    icon: <CompleteRequest />,
    href: "/app/completed-requests",
    role: [3, 4, 5].includes(role),
  },
  {
    name: "Completed Request",
    icon: <CompleteRequest />,
    href: "/app/completed-requestss",
    role: [1, 4].includes(role),
  },
  {
    name: "Report",
  ...
  },
  {
    ...
    icon: <Reports />,
    href: "/app/reports",
    // role: [4].includes(role),
    role: false,
    dropdown: [
      {
        label: "Create Report",
        href: "/app/reports/new-report?s=business_name",
      },
      {
        label: "Create Report",
        href: "/app/reports/new-report?s=limited_liability_company",
      },
      {
        label: "Create Report",
        href: "/app/reports/new-report?s=incorporated_trustees",
      },
    ],
  },
  {
    ...
    icon: <Solicitors />,
    href: "/app/solicitor",
    role: [4, 5].includes(role),
    dropdown: [
      {
        label: "Create Solicitors",
        href: "/app/solicitors/create-new",
      },
      {
        label: "View Unapproved Solicitors",
        href: "/app/solicitors",
      },
    ],
  },
  ...
  {
    name: "Unassigned Solicitors",
    icon: <ApprovedRequest />,
    href: "/app/unassigned-solicitors",
    role: [4].includes(role),
  },
];
